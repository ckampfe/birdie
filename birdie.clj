...
(defn plot-encode-benchmark [[name data-in-order]]
  [name (plot/bar-chart [:unoptimized :one :two :three :four :json] data-in-order)
        (table/table-view (into [] (zipmap [:unoptimized :one :two :three :four :json] data-in-order ))
                          :columns ["phase" "runtime (milliseconds)"] ) 
   ])
;; @@
;; =>
...
;; @@
;; =>
;;; {"type":"list-like","open":"<center><table>","close":"</table></center>","separator":"\n","items":[{"type":"list-like","open":"<tr><th>","close":"</th></tr>","separator":"</th><th>","items":[{"type":"html","content":"Benchmark","value":"#gorilla_repl.html.HtmlView{:content \"Benchmark\"}"},{"type":"html","content":"Plot","value":"#gorilla_repl.html.HtmlView{:content \"Plot\"}"}],"value":"[#gorilla_repl.html.HtmlView{:content \"Benchmark\"} #gorilla_repl.html.HtmlView{:content \"Plot\"}]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-string'>&quot;legend&quot;</span>","value":"\"legend\""},{"type":"list-like","open":"<center><table>","close":"</table></center>","separator":"\n","items":[{"type":"list-like","open":"<tr><th>","close":"</th></tr>","separator":"</th><th>","items":[{"type":"html","content":"<span class='clj-symbol'>phase</span>","value":"phase"},{"type":"html","content":"<span class='clj-symbol'>optimizations</span>","value":"optimizations"}],"value":"[phase optimizations]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-symbol'>unoptimized</span>","value":"unoptimized"},{"type":"html","content":"<span class='clj-string'>&quot;no optimizations, multimethod dispatch&quot;</span>","value":"\"no optimizations, multimethod dispatch\""}],"value":"[unoptimized \"no optimizations, multimethod dispatch\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-symbol'>one</span>","value":"one"},{"type":"html","content":"<span class='clj-string'>&quot;protocol dispatch and transients&quot;</span>","value":"\"protocol dispatch and transients\""}],"value":"[one \"protocol dispatch and transients\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-symbol'>two</span>","value":"two"},{"type":"html","content":"<span class='clj-string'>&quot;loop transients, reduce instead of apply, into vs concat&quot;</span>","value":"\"loop transients, reduce instead of apply, into vs concat\""}],"value":"[two \"loop transients, reduce instead of apply, into vs concat\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-symbol'>three</span>","value":"three"},{"type":"html","content":"<span class='clj-string'>&quot;unroll byte conversion loops, typehint boolean functions, string encode as js array&quot;</span>","value":"\"unroll byte conversion loops, typehint boolean functions, string encode as js array\""}],"value":"[three \"unroll byte conversion loops, typehint boolean functions, string encode as js array\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-symbol'>four</span>","value":"four"},{"type":"html","content":"<span class='clj-string'>&quot;use js arrays internally&quot;</span>","value":"\"use js arrays internally\""}],"value":"[four \"use js arrays internally\"]"}],"value":"#gorilla_repl.table.TableView{:contents [[unoptimized \"no optimizations, multimethod dispatch\"] [one \"protocol dispatch and transients\"] [two \"loop transients, reduce instead of apply, into vs concat\"] [three \"unroll byte conversion loops, typehint boolean functions, string encode as js array\"] [four \"use js arrays internally\"]], :opts (:columns [phase optimizations])}"}],"value":"[\"legend\" #gorilla_repl.table.TableView{:contents [[unoptimized \"no optimizations, multimethod dispatch\"] [one \"protocol dispatch and transients\"] [two \"loop transients, reduce instead of apply, into vs concat\"] [three \"unroll byte conversion loops, typehint boolean functions, string encode as js array\"] [four \"use js arrays internally\"]], :opts (:columns [phase optimizations])}]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-string'>&quot;small vector integers; 10,000 iterations&quot;</span>","value":"\"small vector integers; 10,000 iterations\""},{"type":"vega","content":{"width":400,"height":247.2188,"padding":{"top":10,"left":55,"bottom":40,"right":10},"data":[{"name":"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d","values":[{"x":"unoptimized","y":219},{"x":"one","y":129},{"x":"two","y":64},{"x":"three","y":51},{"x":"four","y":31},{"x":"json","y":196}]}],"marks":[{"type":"rect","from":{"data":"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"width":{"scale":"x","band":true,"offset":-1},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"steelblue"},"opacity":{"value":1}},"hover":{"fill":{"value":"#FF29D2"}}}}],"scales":[{"name":"x","type":"ordinal","range":"width","domain":{"data":"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d","field":"data.x"}},{"name":"y","range":"height","nice":true,"domain":{"data":"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d","field":"data.y"}}],"axes":[{"type":"x","scale":"x"},{"type":"y","scale":"y"}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :values ({:x :unoptimized, :y 219} {:x :one, :y 129} {:x :two, :y 64} {:x :three, :y 51} {:x :four, :y 31} {:x :json, :y 196})}], :marks [{:type \"rect\", :from {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}}"},{"type":"list-like","open":"<center><table>","close":"</table></center>","separator":"\n","items":[{"type":"list-like","open":"<tr><th>","close":"</th></tr>","separator":"</th><th>","items":[{"type":"html","content":"<span class='clj-string'>&quot;phase&quot;</span>","value":"\"phase\""},{"type":"html","content":"<span class='clj-string'>&quot;runtime (milliseconds)&quot;</span>","value":"\"runtime (milliseconds)\""}],"value":"[\"phase\" \"runtime (milliseconds)\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:unoptimized</span>","value":":unoptimized"},{"type":"html","content":"<span class='clj-long'>219</span>","value":"219"}],"value":"[:unoptimized 219]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:one</span>","value":":one"},{"type":"html","content":"<span class='clj-long'>129</span>","value":"129"}],"value":"[:one 129]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:two</span>","value":":two"},{"type":"html","content":"<span class='clj-long'>64</span>","value":"64"}],"value":"[:two 64]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:three</span>","value":":three"},{"type":"html","content":"<span class='clj-long'>51</span>","value":"51"}],"value":"[:three 51]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:four</span>","value":":four"},{"type":"html","content":"<span class='clj-long'>31</span>","value":"31"}],"value":"[:four 31]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:json</span>","value":":json"},{"type":"html","content":"<span class='clj-long'>196</span>","value":"196"}],"value":"[:json 196]"}],"value":"#gorilla_repl.table.TableView{:contents [[:unoptimized 219] [:one 129] [:two 64] [:three 51] [:four 31] [:json 196]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}"}],"value":"[\"small vector integers; 10,000 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :values ({:x :unoptimized, :y 219} {:x :one, :y 129} {:x :two, :y 64} {:x :three, :y 51} {:x :four, :y 31} {:x :json, :y 196})}], :marks [{:type \"rect\", :from {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 219] [:one 129] [:two 64] [:three 51] [:four 31] [:json 196]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-string'>&quot;small vector strings; 10,000 iterations&quot;</span>","value":"\"small vector strings; 10,000 iterations\""},{"type":"vega","content":{"width":400,"height":247.2188,"padding":{"top":10,"left":55,"bottom":40,"right":10},"data":[{"name":"5bbbc398-687e-4366-b828-46fbb3c760ac","values":[{"x":"unoptimized","y":563},{"x":"one","y":374},{"x":"two","y":297},{"x":"three","y":187},{"x":"four","y":102},{"x":"json","y":36}]}],"marks":[{"type":"rect","from":{"data":"5bbbc398-687e-4366-b828-46fbb3c760ac"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"width":{"scale":"x","band":true,"offset":-1},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"steelblue"},"opacity":{"value":1}},"hover":{"fill":{"value":"#FF29D2"}}}}],"scales":[{"name":"x","type":"ordinal","range":"width","domain":{"data":"5bbbc398-687e-4366-b828-46fbb3c760ac","field":"data.x"}},{"name":"y","range":"height","nice":true,"domain":{"data":"5bbbc398-687e-4366-b828-46fbb3c760ac","field":"data.y"}}],"axes":[{"type":"x","scale":"x"},{"type":"y","scale":"y"}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :values ({:x :unoptimized, :y 563} {:x :one, :y 374} {:x :two, :y 297} {:x :three, :y 187} {:x :four, :y 102} {:x :json, :y 36})}], :marks [{:type \"rect\", :from {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}}"},{"type":"list-like","open":"<center><table>","close":"</table></center>","separator":"\n","items":[{"type":"list-like","open":"<tr><th>","close":"</th></tr>","separator":"</th><th>","items":[{"type":"html","content":"<span class='clj-string'>&quot;phase&quot;</span>","value":"\"phase\""},{"type":"html","content":"<span class='clj-string'>&quot;runtime (milliseconds)&quot;</span>","value":"\"runtime (milliseconds)\""}],"value":"[\"phase\" \"runtime (milliseconds)\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:unoptimized</span>","value":":unoptimized"},{"type":"html","content":"<span class='clj-long'>563</span>","value":"563"}],"value":"[:unoptimized 563]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:one</span>","value":":one"},{"type":"html","content":"<span class='clj-long'>374</span>","value":"374"}],"value":"[:one 374]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:two</span>","value":":two"},{"type":"html","content":"<span class='clj-long'>297</span>","value":"297"}],"value":"[:two 297]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:three</span>","value":":three"},{"type":"html","content":"<span class='clj-long'>187</span>","value":"187"}],"value":"[:three 187]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:four</span>","value":":four"},{"type":"html","content":"<span class='clj-long'>102</span>","value":"102"}],"value":"[:four 102]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:json</span>","value":":json"},{"type":"html","content":"<span class='clj-long'>36</span>","value":"36"}],"value":"[:json 36]"}],"value":"#gorilla_repl.table.TableView{:contents [[:unoptimized 563] [:one 374] [:two 297] [:three 187] [:four 102] [:json 36]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}"}],"value":"[\"small vector strings; 10,000 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :values ({:x :unoptimized, :y 563} {:x :one, :y 374} {:x :two, :y 297} {:x :three, :y 187} {:x :four, :y 102} {:x :json, :y 36})}], :marks [{:type \"rect\", :from {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 563] [:one 374] [:two 297] [:three 187] [:four 102] [:json 36]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-string'>&quot;large vector integers; 100 iterations&quot;</span>","value":"\"large vector integers; 100 iterations\""},{"type":"vega","content":{"width":400,"height":247.2188,"padding":{"top":10,"left":55,"bottom":40,"right":10},"data":[{"name":"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1","values":[{"x":"unoptimized","y":8140},{"x":"one","y":3580},{"x":"two","y":3427},{"x":"three","y":2097},{"x":"four","y":1273},{"x":"json","y":3042}]}],"marks":[{"type":"rect","from":{"data":"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"width":{"scale":"x","band":true,"offset":-1},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"steelblue"},"opacity":{"value":1}},"hover":{"fill":{"value":"#FF29D2"}}}}],"scales":[{"name":"x","type":"ordinal","range":"width","domain":{"data":"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1","field":"data.x"}},{"name":"y","range":"height","nice":true,"domain":{"data":"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1","field":"data.y"}}],"axes":[{"type":"x","scale":"x"},{"type":"y","scale":"y"}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :values ({:x :unoptimized, :y 8140} {:x :one, :y 3580} {:x :two, :y 3427} {:x :three, :y 2097} {:x :four, :y 1273} {:x :json, :y 3042})}], :marks [{:type \"rect\", :from {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}}"},{"type":"list-like","open":"<center><table>","close":"</table></center>","separator":"\n","items":[{"type":"list-like","open":"<tr><th>","close":"</th></tr>","separator":"</th><th>","items":[{"type":"html","content":"<span class='clj-string'>&quot;phase&quot;</span>","value":"\"phase\""},{"type":"html","content":"<span class='clj-string'>&quot;runtime (milliseconds)&quot;</span>","value":"\"runtime (milliseconds)\""}],"value":"[\"phase\" \"runtime (milliseconds)\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:unoptimized</span>","value":":unoptimized"},{"type":"html","content":"<span class='clj-long'>8140</span>","value":"8140"}],"value":"[:unoptimized 8140]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:one</span>","value":":one"},{"type":"html","content":"<span class='clj-long'>3580</span>","value":"3580"}],"value":"[:one 3580]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:two</span>","value":":two"},{"type":"html","content":"<span class='clj-long'>3427</span>","value":"3427"}],"value":"[:two 3427]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:three</span>","value":":three"},{"type":"html","content":"<span class='clj-long'>2097</span>","value":"2097"}],"value":"[:three 2097]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:four</span>","value":":four"},{"type":"html","content":"<span class='clj-long'>1273</span>","value":"1273"}],"value":"[:four 1273]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:json</span>","value":":json"},{"type":"html","content":"<span class='clj-long'>3042</span>","value":"3042"}],"value":"[:json 3042]"}],"value":"#gorilla_repl.table.TableView{:contents [[:unoptimized 8140] [:one 3580] [:two 3427] [:three 2097] [:four 1273] [:json 3042]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}"}],"value":"[\"large vector integers; 100 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :values ({:x :unoptimized, :y 8140} {:x :one, :y 3580} {:x :two, :y 3427} {:x :three, :y 2097} {:x :four, :y 1273} {:x :json, :y 3042})}], :marks [{:type \"rect\", :from {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 8140] [:one 3580] [:two 3427] [:three 2097] [:four 1273] [:json 3042]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-string'>&quot;large heterogenous vector; 100 iterations&quot;</span>","value":"\"large heterogenous vector; 100 iterations\""},{"type":"vega","content":{"width":400,"height":247.2188,"padding":{"top":10,"left":55,"bottom":40,"right":10},"data":[{"name":"8acf6cfe-56f9-4277-b39b-ebfc960616e6","values":[{"x":"unoptimized","y":10534},{"x":"one","y":5683},{"x":"two","y":4433},{"x":"three","y":3287},{"x":"four","y":1488},{"x":"json","y":2590}]}],"marks":[{"type":"rect","from":{"data":"8acf6cfe-56f9-4277-b39b-ebfc960616e6"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"width":{"scale":"x","band":true,"offset":-1},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"steelblue"},"opacity":{"value":1}},"hover":{"fill":{"value":"#FF29D2"}}}}],"scales":[{"name":"x","type":"ordinal","range":"width","domain":{"data":"8acf6cfe-56f9-4277-b39b-ebfc960616e6","field":"data.x"}},{"name":"y","range":"height","nice":true,"domain":{"data":"8acf6cfe-56f9-4277-b39b-ebfc960616e6","field":"data.y"}}],"axes":[{"type":"x","scale":"x"},{"type":"y","scale":"y"}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :values ({:x :unoptimized, :y 10534} {:x :one, :y 5683} {:x :two, :y 4433} {:x :three, :y 3287} {:x :four, :y 1488} {:x :json, :y 2590})}], :marks [{:type \"rect\", :from {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}}"},{"type":"list-like","open":"<center><table>","close":"</table></center>","separator":"\n","items":[{"type":"list-like","open":"<tr><th>","close":"</th></tr>","separator":"</th><th>","items":[{"type":"html","content":"<span class='clj-string'>&quot;phase&quot;</span>","value":"\"phase\""},{"type":"html","content":"<span class='clj-string'>&quot;runtime (milliseconds)&quot;</span>","value":"\"runtime (milliseconds)\""}],"value":"[\"phase\" \"runtime (milliseconds)\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:unoptimized</span>","value":":unoptimized"},{"type":"html","content":"<span class='clj-long'>10534</span>","value":"10534"}],"value":"[:unoptimized 10534]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:one</span>","value":":one"},{"type":"html","content":"<span class='clj-long'>5683</span>","value":"5683"}],"value":"[:one 5683]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:two</span>","value":":two"},{"type":"html","content":"<span class='clj-long'>4433</span>","value":"4433"}],"value":"[:two 4433]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:three</span>","value":":three"},{"type":"html","content":"<span class='clj-long'>3287</span>","value":"3287"}],"value":"[:three 3287]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:four</span>","value":":four"},{"type":"html","content":"<span class='clj-long'>1488</span>","value":"1488"}],"value":"[:four 1488]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:json</span>","value":":json"},{"type":"html","content":"<span class='clj-long'>2590</span>","value":"2590"}],"value":"[:json 2590]"}],"value":"#gorilla_repl.table.TableView{:contents [[:unoptimized 10534] [:one 5683] [:two 4433] [:three 3287] [:four 1488] [:json 2590]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}"}],"value":"[\"large heterogenous vector; 100 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :values ({:x :unoptimized, :y 10534} {:x :one, :y 5683} {:x :two, :y 4433} {:x :three, :y 3287} {:x :four, :y 1488} {:x :json, :y 2590})}], :marks [{:type \"rect\", :from {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 10534] [:one 5683] [:two 4433] [:three 3287] [:four 1488] [:json 2590]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-string'>&quot;small map; 10,000 iterations&quot;</span>","value":"\"small map; 10,000 iterations\""},{"type":"vega","content":{"width":400,"height":247.2188,"padding":{"top":10,"left":55,"bottom":40,"right":10},"data":[{"name":"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca","values":[{"x":"unoptimized","y":418},{"x":"one","y":261},{"x":"two","y":242},{"x":"three","y":176},{"x":"four","y":104},{"x":"json","y":145}]}],"marks":[{"type":"rect","from":{"data":"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"width":{"scale":"x","band":true,"offset":-1},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"steelblue"},"opacity":{"value":1}},"hover":{"fill":{"value":"#FF29D2"}}}}],"scales":[{"name":"x","type":"ordinal","range":"width","domain":{"data":"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca","field":"data.x"}},{"name":"y","range":"height","nice":true,"domain":{"data":"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca","field":"data.y"}}],"axes":[{"type":"x","scale":"x"},{"type":"y","scale":"y"}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :values ({:x :unoptimized, :y 418} {:x :one, :y 261} {:x :two, :y 242} {:x :three, :y 176} {:x :four, :y 104} {:x :json, :y 145})}], :marks [{:type \"rect\", :from {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}}"},{"type":"list-like","open":"<center><table>","close":"</table></center>","separator":"\n","items":[{"type":"list-like","open":"<tr><th>","close":"</th></tr>","separator":"</th><th>","items":[{"type":"html","content":"<span class='clj-string'>&quot;phase&quot;</span>","value":"\"phase\""},{"type":"html","content":"<span class='clj-string'>&quot;runtime (milliseconds)&quot;</span>","value":"\"runtime (milliseconds)\""}],"value":"[\"phase\" \"runtime (milliseconds)\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:unoptimized</span>","value":":unoptimized"},{"type":"html","content":"<span class='clj-long'>418</span>","value":"418"}],"value":"[:unoptimized 418]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:one</span>","value":":one"},{"type":"html","content":"<span class='clj-long'>261</span>","value":"261"}],"value":"[:one 261]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:two</span>","value":":two"},{"type":"html","content":"<span class='clj-long'>242</span>","value":"242"}],"value":"[:two 242]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:three</span>","value":":three"},{"type":"html","content":"<span class='clj-long'>176</span>","value":"176"}],"value":"[:three 176]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:four</span>","value":":four"},{"type":"html","content":"<span class='clj-long'>104</span>","value":"104"}],"value":"[:four 104]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:json</span>","value":":json"},{"type":"html","content":"<span class='clj-long'>145</span>","value":"145"}],"value":"[:json 145]"}],"value":"#gorilla_repl.table.TableView{:contents [[:unoptimized 418] [:one 261] [:two 242] [:three 176] [:four 104] [:json 145]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}"}],"value":"[\"small map; 10,000 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :values ({:x :unoptimized, :y 418} {:x :one, :y 261} {:x :two, :y 242} {:x :three, :y 176} {:x :four, :y 104} {:x :json, :y 145})}], :marks [{:type \"rect\", :from {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 418] [:one 261] [:two 242] [:three 176] [:four 104] [:json 145]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-string'>&quot;large map; 100 iterations&quot;</span>","value":"\"large map; 100 iterations\""},{"type":"vega","content":{"width":400,"height":247.2188,"padding":{"top":10,"left":55,"bottom":40,"right":10},"data":[{"name":"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b","values":[{"x":"unoptimized","y":7335},{"x":"one","y":3155},{"x":"two","y":3197},{"x":"three","y":2337},{"x":"four","y":1468},{"x":"json","y":2058}]}],"marks":[{"type":"rect","from":{"data":"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"width":{"scale":"x","band":true,"offset":-1},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","value":0}},"update":{"fill":{"value":"steelblue"},"opacity":{"value":1}},"hover":{"fill":{"value":"#FF29D2"}}}}],"scales":[{"name":"x","type":"ordinal","range":"width","domain":{"data":"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b","field":"data.x"}},{"name":"y","range":"height","nice":true,"domain":{"data":"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b","field":"data.y"}}],"axes":[{"type":"x","scale":"x"},{"type":"y","scale":"y"}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :values ({:x :unoptimized, :y 7335} {:x :one, :y 3155} {:x :two, :y 3197} {:x :three, :y 2337} {:x :four, :y 1468} {:x :json, :y 2058})}], :marks [{:type \"rect\", :from {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}}"},{"type":"list-like","open":"<center><table>","close":"</table></center>","separator":"\n","items":[{"type":"list-like","open":"<tr><th>","close":"</th></tr>","separator":"</th><th>","items":[{"type":"html","content":"<span class='clj-string'>&quot;phase&quot;</span>","value":"\"phase\""},{"type":"html","content":"<span class='clj-string'>&quot;runtime (milliseconds)&quot;</span>","value":"\"runtime (milliseconds)\""}],"value":"[\"phase\" \"runtime (milliseconds)\"]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:unoptimized</span>","value":":unoptimized"},{"type":"html","content":"<span class='clj-long'>7335</span>","value":"7335"}],"value":"[:unoptimized 7335]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:one</span>","value":":one"},{"type":"html","content":"<span class='clj-long'>3155</span>","value":"3155"}],"value":"[:one 3155]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:two</span>","value":":two"},{"type":"html","content":"<span class='clj-long'>3197</span>","value":"3197"}],"value":"[:two 3197]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:three</span>","value":":three"},{"type":"html","content":"<span class='clj-long'>2337</span>","value":"2337"}],"value":"[:three 2337]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:four</span>","value":":four"},{"type":"html","content":"<span class='clj-long'>1468</span>","value":"1468"}],"value":"[:four 1468]"},{"type":"list-like","open":"<tr><td>","close":"</td></tr>","separator":"</td><td>","items":[{"type":"html","content":"<span class='clj-keyword'>:json</span>","value":":json"},{"type":"html","content":"<span class='clj-long'>2058</span>","value":"2058"}],"value":"[:json 2058]"}],"value":"#gorilla_repl.table.TableView{:contents [[:unoptimized 7335] [:one 3155] [:two 3197] [:three 2337] [:four 1468] [:json 2058]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}"}],"value":"[\"large map; 100 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :values ({:x :unoptimized, :y 7335} {:x :one, :y 3155} {:x :two, :y 3197} {:x :three, :y 2337} {:x :four, :y 1468} {:x :json, :y 2058})}], :marks [{:type \"rect\", :from {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 7335] [:one 3155] [:two 3197] [:three 2337] [:four 1468] [:json 2058]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}]"}],"value":"#gorilla_repl.table.TableView{:contents ([\"legend\" #gorilla_repl.table.TableView{:contents [[unoptimized \"no optimizations, multimethod dispatch\"] [one \"protocol dispatch and transients\"] [two \"loop transients, reduce instead of apply, into vs concat\"] [three \"unroll byte conversion loops, typehint boolean functions, string encode as js array\"] [four \"use js arrays internally\"]], :opts (:columns [phase optimizations])}] [\"small vector integers; 10,000 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :values ({:x :unoptimized, :y 219} {:x :one, :y 129} {:x :two, :y 64} {:x :three, :y 51} {:x :four, :y 31} {:x :json, :y 196})}], :marks [{:type \"rect\", :from {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"ba67b0d4-d295-4fc6-a0a0-b6d7be6ab59d\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 219] [:one 129] [:two 64] [:three 51] [:four 31] [:json 196]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}] [\"small vector strings; 10,000 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :values ({:x :unoptimized, :y 563} {:x :one, :y 374} {:x :two, :y 297} {:x :three, :y 187} {:x :four, :y 102} {:x :json, :y 36})}], :marks [{:type \"rect\", :from {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"5bbbc398-687e-4366-b828-46fbb3c760ac\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 563] [:one 374] [:two 297] [:three 187] [:four 102] [:json 36]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}] [\"large vector integers; 100 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :values ({:x :unoptimized, :y 8140} {:x :one, :y 3580} {:x :two, :y 3427} {:x :three, :y 2097} {:x :four, :y 1273} {:x :json, :y 3042})}], :marks [{:type \"rect\", :from {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"61a08e0c-ef9b-4fc4-8c6a-54af8642bef1\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 8140] [:one 3580] [:two 3427] [:three 2097] [:four 1273] [:json 3042]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}] [\"large heterogenous vector; 100 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :values ({:x :unoptimized, :y 10534} {:x :one, :y 5683} {:x :two, :y 4433} {:x :three, :y 3287} {:x :four, :y 1488} {:x :json, :y 2590})}], :marks [{:type \"rect\", :from {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"8acf6cfe-56f9-4277-b39b-ebfc960616e6\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 10534] [:one 5683] [:two 4433] [:three 3287] [:four 1488] [:json 2590]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}] [\"small map; 10,000 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :values ({:x :unoptimized, :y 418} {:x :one, :y 261} {:x :two, :y 242} {:x :three, :y 176} {:x :four, :y 104} {:x :json, :y 145})}], :marks [{:type \"rect\", :from {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"3a9f12ef-9b0d-4dc4-814d-0122f33ea8ca\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 418] [:one 261] [:two 242] [:three 176] [:four 104] [:json 145]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}] [\"large map; 100 iterations\" #gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 55, :bottom 40, :right 10}, :data [{:name \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :values ({:x :unoptimized, :y 7335} {:x :one, :y 3155} {:x :two, :y 3197} {:x :three, :y 2337} {:x :four, :y 1468} {:x :json, :y 2058})}], :marks [{:type \"rect\", :from {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :width {:scale \"x\", :band true, :offset -1}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :value 0}}, :update {:fill {:value \"steelblue\"}, :opacity {:value 1}}, :hover {:fill {:value \"#FF29D2\"}}}}], :scales [{:name \"x\", :type \"ordinal\", :range \"width\", :domain {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :field \"data.x\"}} {:name \"y\", :range \"height\", :nice true, :domain {:data \"a63ce3e3-217f-430c-bfba-78cd2a8f6f5b\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}]}} #gorilla_repl.table.TableView{:contents [[:unoptimized 7335] [:one 3155] [:two 3197] [:three 2337] [:four 1468] [:json 2058]], :opts (:columns [\"phase\" \"runtime (milliseconds)\"])}]), :opts (:columns [#gorilla_repl.html.HtmlView{:content \"Benchmark\"} #gorilla_repl.html.HtmlView{:content \"Plot\"}])}"}
;; <=
